...
| 23 | `dashboard` | `dashboard-surface` | cashier-template, snapshot, sync | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ 验收 33/33 PASS(0 FAIL)；🟪R1通过+🟧修复D-1(templateId string)闭环；含共享面 main.ts 全局权限引导修复；连库维度待 PG CI；P-1 属 games；已合并至 main |
...
| `dashboard-surface` | （已全部完成） | ✅ 完成 | dashboard #23 已合并至 main，本 lane 收官 |
